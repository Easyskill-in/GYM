...
export default function BookingModal({ isOpen, onClose, defaultPlan }) {
  ...
  const finish = () => {
    window.open(`https://wa.me/${BUSINESS.whatsapp}?text=${encodeURIComponent(`Hi Athletica Fitness, I'm interested in the ${selected} plan. Could we talk?`)}`, '_blank', 'noopener');
    onClose();
  };
          ...
          {step === 2 && (
            <div>
              ...
              <div className="modal__options modal__options--half" role="radiogroup" aria-label="Choose time">
                {['Early morning (6–8 AM)', 'Daytime (10 AM–4 PM)', 'Evening (5–10 PM)'].map(t => (
