  ...
  return (
    <section className="hero" id="home">
      ...
      <div className="container hero__inner">
        <span className="hero__loc hero__fade"><i aria-hidden="true" /> Opp. Lourdes Convent School, Athwalines, Athwa · Open {BUSINESS.hours}</span>
        <h1>
          <span className="line"><i>Sculpt.</i></span>
          <span className="line"><i className="hero__outline">Play. Breathe.</i></span>
        </h1>
        <div className="hero__bottom">
          <div>
            <p className="hero__copy hero__fade hero__fade--d1">
              Premium gym with free weights, cardio, CrossFit zone, group classes and certified
              coaches — 4.6★ rated with 451+ reviews, led by 10× Guinness World Record Holder Vispy Kharadi.
            </p>
          ...
          <div className="hero__rating hero__fade hero__fade--d2">
            ...
            <span>451+ reviews on Google</span>
          </div>
        </div>
      </div>
