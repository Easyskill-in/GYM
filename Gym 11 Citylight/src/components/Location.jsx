    ...
    <section className="section" id="location">
      <div className="container location__grid">
        <div className="location__body">
          ...
          <h2 className="h2 reveal" data-d="1">City Light Road,<br />Athwa, Surat.</h2>
          <p className="lead reveal" data-d="2">
            3rd Floor, Shiv Pooja Complex — above Bank of Baroda, opposite Agra Sweets on City Light Road,
            City Light Town, Athwa, Surat. Plus Code: 5Q7W+P7.
          </p>
          <ul className="contact-list reveal" data-d="3">
            ...
            <li><b>Landmark:</b> Above Bank of Baroda, Opposite Agra Sweets, City Light Road</li>
          </ul>
        ...
        <div className="location__map reveal" data-d="1">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3702.2231179336025!2d72.78738617463055!3d21.23859218074066!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjHCsDE0JzE5LjAiTiA3MsKwNDcnMTQuNSJF!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Gym 11 location on Google Maps" />
