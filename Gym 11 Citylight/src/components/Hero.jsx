  ...
  return (
    <section className="hero" id="home">
      ...
      <div className="container hero__inner">
        <span className="hero__loc hero__fade"><i aria-hidden="true" /> Shiv Pooja Complex, City Light Road, Athwa · Open {BUSINESS.hours}</span>
        <h1>
          <span className="line"><i>Train hard.</i></span>
          <span className="line"><i className="hero__outline">Stay strong.</i></span>
        </h1>
        <div className="hero__bottom">
          <div>
            <p className="hero__copy hero__fade hero__fade--d1">
              Complete gym with free weights, cardio, CrossFit zone, yoga, zumba and certified trainers —
              open all days in the heart of Citylight, Surat.
            </p>
          ...
          <div className="hero__rating hero__fade hero__fade--d2">
            <strong>4.5<span className="accent">★</span></strong>
            <span>179+ reviews on Google</span>
          </div>
        </div>
      </div>
