      ...
      <div className="container">
        <div className="transform__inner">
          ...
          <p className="lead reveal" data-d="2" style={{ marginTop: '1.2rem' }}>
            ...
            here's how your first month at Gym 11 is designed to go.
          </p>
        </div>
        <ol className="steps">
          {[
            { step: 'Step 1', h: 'Free trial session', p: 'Walk the floor, try the equipment, meet the trainers. No commitment. Experience the motivating atmosphere.' },
            ...
            { step: 'Step 3', h: 'Your programme', p: 'A personalised plan — weights, CrossFit, yoga, zumba, or a mix — matched to your goals. Variety for every level.' },
            { step: 'Step 4', h: 'Track and adjust', p: 'Regular check-ins with our certified trainers so the plan moves as fast as you do. Consistent progress.' },
          ].map((s, i) => (
