      ...
      <div className="container footer__inner">
        <div className="footer__left">
          <a className="footer__logo" href="#home">
            <span className="logo__mark" aria-hidden="true">11</span> Gym 11
          </a>
          ...
          <div className="footer__links">
            ...
            <a href="https://www.facebook.com/gym11official/" target="_blank" rel="noopener">Facebook</a>
          </div>
        </div>
        <div className="footer__right">
          <p>© {new Date().getFullYear()} Gym 11, Citylight, Athwa, Surat. Demo site only. Built from public info.</p>
