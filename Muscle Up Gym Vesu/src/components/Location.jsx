    ...
    <section className="section" id="location">
      <div className="container location__grid">
        <div className="location__body">
          ...
          <h2 className="h2 reveal" data-d="1">VIP Road,<br />Vesu, Surat.</h2>
          <p className="lead reveal" data-d="2">
            4th Floor, Sun Arcade Mall — on Vesu Main Road, opposite Nandanvan – 2,
            VIP Road, Vesu, Surat. Premium mall location with easy access.
          </p>
          <ul className="contact-list reveal" data-d="3">
            ...
            <li><b>Landmark:</b> Sun Arcade Mall, Opposite Nandanvan – 2, VIP Road</li>
          </ul>
        ...
        <div className="location__map reveal" data-d="1">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3702.2231179336025!2d72.78738617463055!3d21.23859218074066!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjHCsDE0JzE5LjAiTiA3MsKwNDcnMTQuNSJF!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Muscle Up Gym location on Google Maps" />
