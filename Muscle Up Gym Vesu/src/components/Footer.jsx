      ...
      <div className="container footer__inner">
        <div className="footer__left">
          <a className="footer__logo" href="#home">
            <span className="logo__mark" aria-hidden="true">MU</span> Muscle Up Gym
          </a>
        ...
        <div className="footer__right">
          <p>© {new Date().getFullYear()} Muscle Up Gym, Vesu, Surat. Demo site only. Built from public info.</p>
