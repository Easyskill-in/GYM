  ...
  return (
    <section className="hero" id="home">
      ...
      <div className="container hero__inner">
        <span className="hero__loc hero__fade"><i aria-hidden="true" /> Orchid Harmony, Gaurav Path Road, Adajan · Open {BUSINESS.hours}</span>
        <h1>
          <span className="line"><i>Train natural.</i></span>
          <span className="line"><i className="hero__outline">No shortcuts.</i></span>
        </h1>
        <div className="hero__bottom">
          <div>
            <p className="hero__copy hero__fade hero__fade--d1">
              100% steroid-free gym with certified coaches, commercial-grade equipment, and a disciplined
              community — every day except Sunday.
            </p>
          ...
          <div className="hero__rating hero__fade hero__fade--d2">
            ...
            <span>434+ reviews on Google</span>
          </div>
        </div>
      </div>
