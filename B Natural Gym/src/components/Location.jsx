    ...
    <section className="section" id="location">
      <div className="container location__grid">
        <div className="location__body">
          ...
          <h2 className="h2 reveal" data-d="1">Gaurav Path Road,<br />Adajan, Surat.</h2>
          <p className="lead reveal" data-d="2">
            4th Floor, Orchid Harmony — opposite Palanpore Fire Station on Gaurav Path Road, Adajan.
            Two branches also available in Pal, Surat.
          </p>
          <ul className="contact-list reveal" data-d="3">
            ...
            <li><b>Pal Branch:</b> 308, 4th Floor Raj Arcade, Near Pal Gam Circle — 7574020401</li>
          </ul>
        ...
        <div className="location__map reveal" data-d="1">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3702.2231179336025!2d72.78738617463055!3d21.23859218074066!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjHCsDE0JzE5LjAiTiA3MsKwNDcnMTQuNSJF!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="B Natural Gym location on Google Maps" />
