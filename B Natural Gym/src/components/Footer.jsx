      ...
      <div className="container footer__inner">
        <div className="footer__left">
          <a className="footer__logo" href="#home">
            <span className="logo__mark" aria-hidden="true">BN</span> B Natural Gym
          </a>
          ...
          <div className="footer__links">
            ...
            <a href="https://www.bnaturalfitness.com" target="_blank" rel="noopener">Website</a>
          </div>
        </div>
        <div className="footer__right">
          <p>© {new Date().getFullYear()} B Natural Gym, Adajan, Surat. Demo site only. Built from public info.</p>
