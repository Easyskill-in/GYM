      ...
      <div className="container footer__inner">
        <div className="footer__left">
          <a className="footer__logo" href="#home">
            <span className="logo__mark" aria-hidden="true">H</span> Hustlers Health & Fitness
          </a>
          ...
          <div className="footer__links">
            ...
            <a href="https://www.facebook.com/HustlersHealthFitness/" target="_blank" rel="noopener">Facebook</a>
          </div>
        </div>
        <div className="footer__right">
          <p>© {new Date().getFullYear()} Hustlers Health & Fitness, Adajan. Demo site only. Built from public info.</p>
