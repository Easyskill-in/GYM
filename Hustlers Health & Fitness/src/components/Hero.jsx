  ...
  return (
    <section className="hero" id="home">
      ...
      <div className="container hero__inner">
        <span className="hero__loc hero__fade"><i aria-hidden="true" /> Pyramid Square, LP Savani Circle, Adajan · Open {BUSINESS.hours}</span>
        <h1>
        ...
        <div className="hero__bottom">
          <div>
            <p className="hero__copy hero__fade hero__fade--d1">
              Air-conditioned gym with sauna, free weights, CrossFit zone, and group classes —
              362 days a year with coaches who actually watch your form.
            </p>
          ...
          <div className="hero__rating hero__fade hero__fade--d2">
            ...
            <span>734+ reviews on Google</span>
          </div>
        </div>
      </div>
